...
- **Solution**:
  ...
  8. Expand the Step titled **Run git clone --depth=1 https://github.com/virtual-labs/ph3-lab-mgmt** and inspect the build logs. You will see the following error ```error: uncaughtException: /home/runner/work/exp-repo-name/exp-repo-name/build/exp-repo-name/filename.json: Unexpected token 	 in JSON at position 203 SyntaxError: /home/runner/work/exp-repo-name/exp-repo-name/build/exp-repo-name/filename.json: Unexpected token 	 in JSON at position 203.```
