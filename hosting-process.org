...
*** Hosting Request Lifecycle
    ...
    7.  Once the hosting is successful, the requester will
        ...
        requester should change the status from *Hosted* to
...
* Roles and Responsibilities
  ...
  |         | Labeling the hosting request issue as         |                  |
  ...
  |         | requester  and labeling the hosting           |                  |
  |         | request issue to *Hosted*                     |                  |
  |---------+-----------------------------------------------+------------------|
  |      9. | Providing the causes/nature  of failure       | Hosting team     |
  |         | and labeling the hosting request issue to     |                  |
  |         | *Failed*                                      |                  |
  |---------+-----------------------------------------------+------------------|
  |     10. | Validating the hosted code                    | Requester        |
  |---------+-----------------------------------------------+------------------|
  |     11. | Labeling the hosting request issue as         | Requester        |
  ...
  |         | labeling the issue as *Reverted*              |                  |
  |---------+-----------------------------------------------+------------------|
