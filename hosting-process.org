...
* Hosting Process for Phase III Experiment/Labs 
  ...
  - Step 1 :: IIITH will create lab repos for all the labs
              that are ready ( marked in green) in the
  ...
  - Step 6 :: On approval from IITB , IIITH will populate
              the lab landing page information
              (Introduction, Objective, List of experiments,
